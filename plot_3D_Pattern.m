...
% General stuff
plot3Dparams.dB_Lim = 40;
plot3Dparams.ra = 1.1; % length of normalized x/y/z-axis vector
plot3Dparams.cbo = 0; % colorbar on ?
plot3Dparams.View = [50 30]; % view [el,az] angles
plot3Dparams.ScaleColors = 1; % scale colors for uniformity acorss |E|,P,dB?
...
plot3Dparams.Cyl.Flat_or_Surf = 2; % 1=flat (pcolor-like), 2=surf
